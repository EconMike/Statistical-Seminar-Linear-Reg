...
This repository has been set up to store the R code for th linear regression seminar.
...
0.004276 0.341900 0.695700 0.595000 0.881900 0.998500 
...
> plot(newdata$PCE,newdata$WAGES)
